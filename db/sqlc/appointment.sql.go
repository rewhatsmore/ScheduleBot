...
RETURNING appointment_id, training_id, user_id, created_at
`
...
func (q *Queries) CreateAppointment(ctx context.Context, arg CreateAppointmentParams) (Appointment, error) {
	row := q.db.QueryRowContext(ctx, createAppointment, arg.TrainingID, arg.UserID)
	var i Appointment
	err := row.Scan(
		&i.AppointmentID,
		&i.TrainingID,
...
SELECT appointment_id, training_id, user_id, created_at FROM appointments
